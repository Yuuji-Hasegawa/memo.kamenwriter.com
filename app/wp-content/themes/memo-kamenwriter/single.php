    ...
    <div class="c-entry">
        ...
        <dl class="c-table">
            ...
            <dd class="c-table__content">
                <?php echo get_post_meta($post->ID, 'content_title', true);?>
            </dd>
            <dt class="c-table__title">
                版元
            </dt>
            <dd class="c-table__content">
                <?php echo get_post_meta($post->ID, 'content_pub', true);?>
            </dd>
            <dt class="c-table__title">
                制作者
            </dt>
            <dd class="c-table__content">
                <?php echo get_post_meta($post->ID, 'content_author', true);?>
            </dd>
            <dt class="c-table__title">
                初版/リリース/公開日
            </dt>
            <dd class="c-table__content">
                <time
                    datetime="<?php echo date_format(date_create(get_post_meta($post->ID, 'content_date', true)), 'Y-m-d');?>"><?php echo date_format(date_create(get_post_meta($post->ID, 'content_date', true)), 'Y年m月d日');?></time>
            </dd>
            <dt class="c-table__title">
                関連タイトル
            </dt>
            ...
            <dd class="c-table__content">
                <a href="<?php echo esc_url(get_post_meta($post->ID, 'content_url', true));?>"
                    target="_blank" rel="noopener">
                    <?php echo esc_url(get_post_meta($post->ID, 'content_url', true));?>
                </a>
            </dd>
            <dt class="c-table__title">
                作業状況
